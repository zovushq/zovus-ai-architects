...
const Services = () => {
  ...
  const services = [{
    ...
    description: "Help law firms grow online using AI Avatars to create educational content that builds authority and generates leads.",
    features: ["AI Avatar content creation", "Authority building strategy", "Automated lead conversion", "Social media presence"],
    ...
    features: ["Custom AI agent development", "Process automation", "Cost reduction strategies", "Seamless integration"],
    cta: "Build AI Agents",
    ...
    features: ["AI strategy development", "Opportunity assessment", "Implementation roadmap", "ROI optimization"],
  ...
  return <section id="services" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <Card key={index} className="border border-gray-200 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white">
              <CardContent className="p-8">
                ...
                <ul className="space-y-2 mb-8">
                  {service.features.map((feature, idx) => <li key={idx} className="flex items-center text-gray-800">
                      <div className="w-2 h-2 bg-[#E40223] rounded-full mr-3"></div>
                      {feature}
                    </li>)}
                </ul>
                
                <Button className="w-full" onClick={() => handleNavigation(service.link, service.isExternal)}>
                  {service.cta}
