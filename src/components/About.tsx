        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Practical AI</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Your Tech Partner</h3>
              <p className="text-gray-600">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <blockquote className="text-2xl font-medium text-gray-900 text-center mb-6">
            ...
            <div className="text-center">
              <div className="text-blue-600 font-semibold">The ZOVUS Team</div>
            </div>
          </div>
        </div>
      </div>
